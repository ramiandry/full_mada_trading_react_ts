      ...
      >
        <div className="w-full" id="content">
          ...
          <Typography sx={stylesMui.policyText}>
            ...
            and Wealth Funding LLC (“Company,” “we,” “us,” or “our”), concerning your
            access to and use of the https://www.tuffx.com website as well as
            any other media form, media channel, mobile website or mobile
            application related, linked, or otherwise connected thereto
            (collectively, the “Site”). We are registered in Dubai and have our
            registered office at (INSERT COMPANY ADDRESS HERE). You agree that
            ...
            trading account and all funds remain the property of Wealth Funding  &
            ...
            intermediary. <br />
            <br />
            Any such direct and non Wealth Funding sanctioned contact with any Wealth Funding
            broker or intermediary will result in instant termination and
            trading account closure. 1.2 Live funded traders who successfully
            pass Phase 1 & 2 of the evaluation will be entitled to the following
            Virtual Performance Fee made on the account: (80%) Virtual Profit
            withdrawals on funded accounts are available bi-weekly. There is no
            minimum withdrawal requirement. Please submit a withdrawal request
            in the form of an invoice addressed to Alpha Capital Group limited
            on the 14th & 28th of each month. All withdrawals will be processed
            and paid within 3 business days. All trades must be closed on the
            account at the time of making a withdrawal request, trading can
            resume once the withdrawal amount has been withdrawn from the
            trading Virtual account balance. Please submit all withdrawal
            requests to support@tuffx.com 1.3 Virtual Profit withdrawals will be
            sent via bank wire transfer, or cryptocurrency. We have partnered
            with a deliverable FX institution meaning our clients can benefit
            from 0.35% exchange rate fees when receiving Virtual profit
            withdrawals in your domestic currencies. 1.4 Each individual trader
            is limited to 1 active evaluation account at any one time. With a
            max capital allocation of $200,000 1.5 , If a trader reaches the
            time limit but hasn’t reached the required Virtual profit target and
            all other trading rules have been met. If the account is in profit
            and no other rules have been breached, you will automatically
            qualify. 1.6 To be eligible for capital growth, the trader is
            required to reach a 6% Virtual profit target for Phase 1 and 8%
            Virtual profit target for Phase 2. Max capital growth is $500,000
            1.7 If the trader has met all the required trading objectives within
            the set time frame and hasn’t breached any rules, then the trader
            will pass the evaluation phase and move onto Phase 2 or a funded
            account. 1.8 Upon successful completion of the evaluation phase(s),
            a trader’s agreement between Wealth Funding LLC and the trader will be
            signed prior to receiving the live simulated account. 1.9 Traders
            are not allow copy trading from other groups. We don’t not allow
            traders to copy other traders’ trades either. No Group copy trading
            is allowed. The only copy trading allowed is that from your own
            external account to your account with 
             Wealth Funding. Any traders found copy
            trading other traders’ trades will be subject to review and
            potential breach of agreement, meaning you will lose the funded
            account. 1.10 Tradeable Assets: FX/Indices/Commodities 1.11
            ******Martingale EAs & Strategies are not allowed. Wealth Funding consider
            Martingale strategies to be the following: Opening a position in the
            same direction whilst the first position opened is in drawdown. If
            the consecutive position is opened at an exponent more than 1.1x we
            consider this to be martingale strategy. If the trader breaches this
            rule, it will result in a fail on the evaluation. 1.12 Hedging and
            stacking trades is allowed Hedging Is classified as the following:
            having trades running in both directions on the same instrument.
            Stacking is classified as the following: opening 3 or more trades on
            the same instrument at the same time at the same price. If the
            trader breaches this rule, it will result in a fail on the
            evaluation. 1.13 Alpha Pro Plan Phase 1 & Phase 2 consist of no
            minimum trading days. Traders must continue to trade until you meet
            the minimum trading days requirement. We understand that if a trader
            has reached the Virtual profit target they may not want to risk
            taking a loss and having to regain Virtual profit require to pass.
            1.14 There are no Virtual profit targets that need to be met before
            requesting for a withdrawal on a funded account. once the trader has
            successfully achieved a funded account with Alpha Capital Group,
            ***********************there are no Virtual profit requirements or
            ...
            execute these Terms of Use. DISCLAIMER Wealth Funding LLC does not carry out
            ...
            have a money managers license. Wealth Funding LLC is not a broker, and do
            ...
            afford to lose FUNDED ACCOUNT DISCLAIMER Funded Account Disclaimer:
            ...
            shown. Wealth Funding accounts are not live trading accounts, they are fully
            simulated accounts utilizing real market quotes from liquidity
            providers. The Traders featured are representative only and includes
            selected traders who allow their names to be publicly disclosed.
            Trader performance quoted represents past performance in a simulated
            ...
            referenced by or undertaken utilizing Wealth Funding may not be suitable for
            all persons. CONTACT US In order to resolve a complaint regarding
