      ...
      >
        <div className="w-full" id="content">
          ...
          <Typography sx={stylesMui.policyText}>
            Thank you for choosing to be part of our community at Wealth Funding
            ...
            support@tuffx.com This privacy notice describes how we might use
            your information if you: <br />
            <br />
            Visit our website at https://www.tuffx.com <br />
            <br />
            ...
            please contact us at support@tuffx.com and be sure to include your
            name, testimonial location, and contact information. Request
            ...
            contact us at support@tuffx.com WHAT ARE YOUR PRIVACY RIGHTS? In
            Short: In some regions, such as the European Economic Area (EEA) and
            ...
            change, or terminate your account at any time. In some regions (like
            the EEA and UK), you have certain rights under applicable data
            protection laws. These may include the right (i) to request access
            ...
            support@tuffx.com Account Information If you would at any time like
            to review or change the information in your account or terminate
            your account, you can: Contact us using the contact information
            ...
            support@tuffx.com or by post to: Wealth Funding LLC (INSERT COMPANY ADDRESS
            WHERE MAIL CAN BE PICKED UP) HOW CAN YOU REVIEW, UPDATE, OR DELETE
            THE DATA WE COLLECT FROM YOU? Based on the applicable laws of your
            country, you may have the right to request access to the personal
            information we collect from you, change that information, or delete
            it in some circumstances. To request to review, update, or delete
            your personal information, please submit a request form by clicking
            here. NOTES: have developer input a link to a support ticket with
            subject automatically titled “Removal of personal information”
          </Typography>
        </div>
      </div>
    </section>
